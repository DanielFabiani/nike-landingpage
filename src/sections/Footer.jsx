  ...
  return (
    <footer className="max-container">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base leading-7 font-montserrat text-white sm:max-w-sm">
            En nuestra tienda, encontrarás la perfecta combinación de comodidad
            y estilo en cada par de zapatillas. ¡Eleva tu juego y tu estilo con
      ...
      <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
        <div className="flex flex-1 justify-start items-center pag-2 font-montserrat cursor-pointer">
          <img
            src={copyrightSign}
            alt="Copyright"
            width={20}
        ...
        >
          Hecho con amor ♥️ por Daniel Fabiani
        </a>
      </div>
    </footer>
  );
